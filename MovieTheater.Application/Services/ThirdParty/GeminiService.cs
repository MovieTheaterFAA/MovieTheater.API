...
<table style="width: 100%; border: 1px solid #ddd; border-collapse: collapse;">
    <thead style="background-color: #f4f4f4; font-weight: bold;">
        <tr>
            <th style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Món</th>
            <th style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Loại</th>
            <th style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Giá</th>
            <th style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Mô tả</th>
        </tr>
    </thead>
        <tbody>
            <tr style="background-color: #f9f9f9;">
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Cheese Sausage</td>
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Đồ ăn</td>
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">30000</td>
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Xúc xích nóng chảy phô mai, ngon bá cháy.</td>
            </tr>
            <tr style="background-color: #f9f9f9;">
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Combo 1: Popcorn + Pepsi</td>
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Combo</td>
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">65000</td>
                <td style="padding: 8px 12px; border: 1px solid #ddd; text-align: left;">Combo bắp rang bơ và một lon Pepsi, siêu hời.</td>
            </tr>
                ...
        </tbody>
</table>
