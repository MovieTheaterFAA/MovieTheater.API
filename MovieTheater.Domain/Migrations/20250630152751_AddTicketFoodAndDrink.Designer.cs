...
namespace MovieTheater.Domain.Migrations
{
    ...
    [Migration("20250630152751_AddTicketFoodAndDrink")]
    partial class AddTicketFoodAndDrink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieTheater.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MovieTheater.Domain.Entities.BookingFood", b =>
                {
                    ...
                    b.HasKey("BookingId", "FoodAndDrinkId");
            ...
            modelBuilder.Entity("MovieTheater.Domain.Entities.Movie", b =>
                {
                    ...
                    b.Property<List<string>>("ActorsUrl")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("MovieTheater.Domain.Entities.OtpStorage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MovieTheater.Domain.Entities.ShowTimeSeat", b =>
                {
                    b.Property<Guid>("ShowTimeId")
                        .HasColumnType("uuid");
