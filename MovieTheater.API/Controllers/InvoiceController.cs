...
namespace MovieTheater.API.Controllers
{
    ...
    public class InvoiceController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateInvoice(Guid id, [FromQuery] Guid? promotionId = null)
        {
            try
            {
                var invoice = await _invoiceService.CreateInvoiceAsync(id, promotionId);
